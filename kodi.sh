...
cd ${GITHUB_WORKSPACE}
sudo chroot ./arch/root.x86_64/ /bin/bash -c "pacman -Syyu --noconfirm && pacman -S kodi wireplumber pipewire pipewire-pulse pipewire-alsa pipewire-jack --noconfirm && pacman -Scc --noconfirm || true && rm -rf /var/cache/pacman/pkg/*"
